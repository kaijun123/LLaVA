...
if __name__ == "__main__":
    ...
    vision_tower_path = "/home/r11kaijun/LLaVA/checkpoints/vision_tower-epoch-1-lr-0.0001"
    image_processor_path = "/home/r11kaijun/LLaVA/checkpoints/vision_tower-epoch-1-lr-0.0001"


    configure_vision_tower(
        model_path="/home/r11kaijun/LLaVA/checkpoints/liuhaotian-llava-v1.5-7b",
        model_base=None,
        model_name="liuhaotian-llava-v1.5-7b",
        model_args=ModelArguments(vision_tower_path=vision_tower_path, image_processor_path=image_processor_path),
        save_model_path="/home/r11kaijun/LLaVA/checkpoints/liuhaotian-llava-v1.5-7b-vision_tower-epoch-1-lr-0.0001",
    )
