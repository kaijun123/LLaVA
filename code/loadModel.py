...
if __name__ == "__main__":
    ...
    print("llava loadModel")

    model_path='microsoft/llava-med-v1.5-mistral-7b'
    # '/home/r11kaijun/LLaVA/checkpoints/lora-liuhaotian-llava-v1.5-7b-vision_tower-epoch-1-lr-0.0001-train_28k_custom-train-mlp-and-llm-unquantized-epoch-2-lr-6e-5'
    model_base=None
    # '/home/r11kaijun/LLaVA/checkpoints/liuhaotian-llava-v1.5-7b'

    model_name='llava-med-v1.5-mistral-7b'
    image_processor_path="openai/clip-vit-large-patch14-336"
    # "/home/r11kaijun/LLaVA/checkpoints/vision_tower-epoch-1-lr-0.0001"
    vision_tower_path="openai/clip-vit-large-patch14-336"
    # "/home/r11kaijun/LLaVA/checkpoints/vision_tower-epoch-1-lr-0.0001"
    ...
    validate(
        data_path="/home/r11kaijun/MIMIC-CXR/processed_data/test_custom.json",
        image_base_path="/home/r11kaijun/physionet.org/files/mimic-cxr-jpg/2.1.0",
        model=finetuned_model,
        tokenizer=finetuned_tokenizer,
        image_processor=finetuned_image_processor,
        output_path="/home/r11kaijun/LLaVA/test-results/llava-med-v1.5-mistral-7b.json"
    )
