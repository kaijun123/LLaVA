...
def test_validation_set(vision_tower_instance, classifier, val_loader):
    '''Generate the y_true and y_pred for '''
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    vision_tower_instance.to(device)
    classifier.to(device)
...
if __name__ == "__main__":
  ...
  validation_data = CustomImageDataset(
      annotations_file="~/Datasets/mimic-cxr/processed_data/processed_mimic-cxr-2.0.0-chexpert_validate.csv",
      img_dir="/home/FYP/angk0064/Datasets/mimic-cxr-jpg/2.1.0",
  )
...
#     annotations_file="~/Datasets/mimic-cxr/processed_data/processed_mimic-cxr-2.0.0-chexpert_train.csv",
#     img_dir="/home/FYP/angk0064/Datasets/mimic-cxr-jpg/2.1.0",
# )
# validation_data = CustomImageDataset(
#     annotations_file="~/Datasets/mimic-cxr/processed_data/processed_mimic-cxr-2.0.0-chexpert_validate.csv",
