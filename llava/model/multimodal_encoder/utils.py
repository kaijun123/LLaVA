...
class ModelArguments:
    ...
    mm_vision_select_feature: Optional[str] = field(default="cls")  # use cls for multi-label classification
...
def train_clip_classifier(
    ...
    vision_tower_instance.image_processor.save_pretrained(save_directory=os.path.join(output_dir, f"vision_tower-epoch-{epochs}-lr-{lr}"))
