if __name__ == "__main__":
  ...
  vision_tower_instance = utils.load_existing_vision(vision_tower_path)
  ...
  y_true, y_pred = utils.test_validation_set(vision_tower_instance, classifier, validation_dataloader)
